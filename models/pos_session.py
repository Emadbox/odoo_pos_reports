...
# X - Report
    ...
    # comment:TITO///////////////////////////////////////////////////////////////////////////////////////////////////
    @api.multi
    def get_product_category_x_don_enrique_real(self):
        product_list = []
        ...
        for x in product_list:
            ...
            if price_loop > 0:
                ...
                category_id = x.get('pos_categ_id')
                if category_id:
                    category_name = self.env['pos.category'].browse([category_id]).name
                if category_name == 'PAGOS':
                    price_pagos = abs(price_loop)
        balance_end_real_don_enrique_real = balance_end_real + price_pagos
        return balance_end_real_don_enrique_real
    # comment:TITO///////////////////////////////////////////////////////////////////////////////////////////////////
    # comment:TITO///////////////////////////////////////////////////////////////////////////////////////////////////
    @api.multi
    def get_product_category_x_don_enrique_real_get_beca(self):
        product_list = []
        balance_end_real_don_enrique_real = 0.0
        balance_end_real = 0.0
        if self and self.order_ids:
        ...
        for x in product_list:
            ...
            if price_loop > 0:
                ...
                if category_id:
                    category_name = self.env['pos.category'].browse([category_id]).name
                if category_name == 'BECA':
                    price_beca = abs(price_loop)
        return price_beca
    # comment:TITO///////////////////////////////////////////////////////////////////////////////////////////////////
    # comment:TITO///////////////////////////////////////////////////////////////////////////////////////////////////
    @api.multi
    def get_product_category_x_don_enrique_real_get_pagos(self):
        product_list = []
        balance_end_real_don_enrique_real = 0.0
        balance_end_real = 0.0
        if self and self.order_ids:
